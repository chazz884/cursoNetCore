...
namespace WebApiAutores.Controllers.V1
{
    ...
    public class ComentariosController : ControllerBase 
    {
        ...
        {
            // los claims solo se pueden acceder bajo el contexto de [Authorize]
        ...
        [HttpPut("{id:int}", Name = "actualizarComentario")]// [HttpPut("{id:int}")] se establece o complementa la ruta definida arriba api/autores/id 
